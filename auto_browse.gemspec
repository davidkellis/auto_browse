...
require_relative "lib/auto_browse/version"

Gem::Specification.new do |spec|
  spec.name = "auto_browse"
  spec.version = AutoBrowse::VERSION
  spec.authors = ["David Ellis"]
  spec.email = ["david@conquerthelawn.com"]

  spec.summary = "auto_browse is a browser driver."
  spec.description = "auto_browse is a browser driver."
  spec.homepage = "https://github.com/davidkellis/auto_browse"
  spec.license = "MIT"
